...
export const domain={
 ...
 tagline:'让每一次补货，都有需求信号和业务依据',storyTitle:'从历史销量到未来需求，<br/>保留模型与人的共同判断',storyText:'把预测、活动、库存与补货建议连接在一起，让计划团队更早看见缺货和积压风险。',pattern:[3,6,8,12,15,18,21,24,27,29,31],loginStats:[['2,480','预测 SKU'],['82.6%','预测准确率'],['16','高偏差对象']],loginTitle:'需求计划指挥台',adminDemo:'供需 / 版本 / 模型',fieldDemo:'预测 / 调整 / 确认'
}
